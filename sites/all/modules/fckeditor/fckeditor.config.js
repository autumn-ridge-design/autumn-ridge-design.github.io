...
FCKConfig.Plugins.Add( 'reg' ) ;
FCKConfig.Plugins.Add( 'trade' ) ;
...
/*
 Test Toolbar Config - Symmetri custom defaults
 */
 
FCKConfig.ToolbarSets["SymmetriCustom"] = [
['Source'],
['Cut','Copy','Paste','-','PasteText'],
['Undo','Redo','-','Find','Replace'],
'/',
['Bold','Italic','-','reg','trade'],
